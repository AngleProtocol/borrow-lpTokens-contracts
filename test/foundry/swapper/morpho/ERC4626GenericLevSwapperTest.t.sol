...
import { SwapType, ERC4626GenericLevSwapper, IUniswapV3Router, IAngleRouterSidechain } from "borrow-staked/swapper/LevSwapper/ERC4626GenericLevSwapper.sol";
import { IMorphoBase } from "morpho-blue/interfaces/IMorpho.sol";
import "@openzeppelin/contracts/interfaces/IERC4626.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol";

contract ERC4626GenericLevSwapperTest is BaseTest {
    ...
    ERC4626GenericLevSwapper public swapper;
    IERC20 public asset;
    ...
    function setUp() public override {
        ...
        swapper = new ERC4626GenericLevSwapper(coreBorrow, _UNI_V3_ROUTER, _ONE_INCH, _ANGLE_ROUTER, MORPHO);
        asset = IERC20(0xdd0f28e19C1780eb6396170735D45153D261490d);
        collateral = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    ...
    function test_Leverage_NoSwap_Success(uint256 amount) public {
        ...
        bytes memory addData = abi.encode(collateral, asset);
    ...
    function test_Deleverage_NoSwap_Success(uint256 amount) public {
        ...
        bytes memory removeData = abi.encode(asset, uint256(minAmountOut));
