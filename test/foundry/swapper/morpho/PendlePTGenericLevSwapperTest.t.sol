...
import { SwapType, PendlePTGenericLevSwapper, BaseLevSwapperMorpho, IUniswapV3Router, IAngleRouterSidechain, IStandardizedYield, IPYieldTokenV2, IPMarketV3 } from "borrow-staked/swapper/LevSwapper/PendlePTGenericLevSwapper.sol";
import { IMorphoBase } from "morpho-blue/interfaces/IMorpho.sol";

contract PendlePTGenericLevSwapperTest is BaseTest {
    ...
    BaseLevSwapperMorpho public swapper;
    IERC20 constant collateral = IERC20(0xCd5fE23C85820F7B72D0926FC9b05b43E359b7ee);
    IStandardizedYield constant sy = IStandardizedYield(0xAC0047886a985071476a1186bE89222659970d65);
    IPYieldTokenV2 constant yt = IPYieldTokenV2(0x129e6B5DBC0Ecc12F9e486C5BC9cDF1a6A80bc6A);
    IPMarketV3 constant market = IPMarketV3(0x7d372819240D14fB477f17b964f95F33BeB4c704);
    IERC20 constant pt = IERC20(0x6ee2b5E19ECBa773a352E5B21415Dc419A700d1d);
    IERC20 constant asset = pt;
    ...
    function setUp() public override {
        ...
        swapper = new PendlePTGenericLevSwapper(coreBorrow, _UNI_V3_ROUTER, _ONE_INCH, _ANGLE_ROUTER, MORPHO);
    ...
    function test_Leverage_NoSwap_Success(uint256 amount) public {
        ...
        bytes memory addData = abi.encode(collateral, sy, market);
    ...
    function test_Deleverage_NoSwap_Success(uint256 amount) public {
        ...
        bytes memory removeData = abi.encode(collateral, sy, market, pt, uint256(minAmountOut));
