...
contract OracleCrvUSDBTCETHEUR is BaseOracleChainlinkMulti {
    ...
    function circuitChainlink() public pure returns (AggregatorV3Interface[] memory) {
        AggregatorV3Interface[] memory circuitChainlink_ = new AggregatorV3Interface[](4);
        // Chainlink DAI/USD address
        circuitChainlink_[0] = AggregatorV3Interface(0x4746DeC9e833A82EC7C2C1356372CcF2cfcD2F3D);
        // Chainlink USDC/USD address
        circuitChainlink_[1] = AggregatorV3Interface(0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7);
        // Chainlink USDT/USD address
        circuitChainlink_[2] = AggregatorV3Interface(0x0A6513e40db6EB1b165753AD52E80663aeA50545);
        // Chainlink EUR/USD address
        circuitChainlink_[3] = AggregatorV3Interface(0x73366Fe0AA0Ded304479862808e02506FE556a98);
