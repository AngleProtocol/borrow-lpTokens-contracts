...
contract OracleFRAXBPEURChainlink is BaseOracleChainlinkMulti {
    ...
    function circuitChainlink() public pure returns (AggregatorV3Interface[] memory) {
        ...
        circuitChainlink_[0] = AggregatorV3Interface(0xB9E1E3A9feFf48998E45Fa90847ed4D467E8BcfD);
        // Chainlink USDC/USD address
        circuitChainlink_[1] = AggregatorV3Interface(0x8fFfFfd4AfB6115b954Bd326cbe7B4BA576818f6);
